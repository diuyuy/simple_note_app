class RouterPath {
  ...
  static const String searchNoteSelectionPage = '/searchNoteSelection';

  static const String favoritesPage = '/favorites';
  static const String favoritesSelectionPage = '/favoriteSelection';

  static const String wastebasketPage = '/trash';
  static const String wastebasketSelectionPage = '/wasteSelection';

  //Note Category paths
  static const String noteCategoryPage = '/noteCategory';
  static const String addNoteTocategoryPage = 'addNoteToCategory';
  static const String createNoteFromCategory = 'createNoteFromCategory';
